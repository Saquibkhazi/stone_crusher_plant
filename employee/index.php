...
$sql="select employees.id,employees.name,employees.gender,employees.dob,
employees.mobile,employees.state,employees.city,employees.address,
 employees.designation,employees.adhaar,employees.email,
 employees.country,departments.name as deptname from employees inner join departments on departments.id=employees.department_id  where employees.admin_user_id=$id";
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="index.php?id=<?php echo $id?>" class="dropdown-toggle no-arrow">
							...
							<tr>
							  ...
							  <td><?php echo $row['id']?></td>
							   ...
							   <td><?php echo $row['deptname'] ?>  </td>
								...
								echo "<a href='salary.php?id=".$row['id']."'><h6 style=color:blue;>Show Salary</h6></a>&nbsp;";
