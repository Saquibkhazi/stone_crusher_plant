...
if(isset($_POST['submit'])){
	...
	if(true){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			mysqli_query($con,"insert into leaveapplications(formdate,tilldate,purpose,numberofdays,status,employee_id) values('$formdate','$tilldate','$purpose','$numberofdays','$status','$id')");
		}
		header("location:employeeLeaveApplication.php?id=".$id);
		die();
	}
	}
...
<body>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="employeeLeaveApplication.php?id=<?php echo $row['id']?>" class="dropdown-toggle no-arrow">
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><div class="weight-600 font-30 text-blue">LEAVE APPLICATION</div></label>			
	</div>			
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6> FROM DATE</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="date" name="formdate" class="form-control" required>	
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>TILL DATE </h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="date" name="tilldate"  class="form-control" required>
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>Purpose</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="purpose" placeholder="ENTER THE PURPOSE" class="form-control" required >
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>Number of days</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="number" name="numberofdays" placeholder="ENTER NUMBER OF DAYS" class="form-control" required >
		</div>
	</div>
