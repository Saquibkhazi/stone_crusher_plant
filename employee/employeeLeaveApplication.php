...
if(isset($_GET['type']) && $_GET['type']=='delete' && isset($_GET['employee_id']) && $_GET['employee_id']!=''){
	$type=get_safe_value($con,$_GET['type']);
	if($type=='delete'){
		$id=get_safe_value($con,$_GET['employee_id']);
		$delete_sql="delete from operations where id='$id'";
		mysqli_query($con,$delete_sql);
	}
}

$sql="select * from leaveapplications where employee_id=$id";
			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">LEAVES DETAIL</h4>
							   <button type="button" class="btn btn-outline-info"> <h6 class="box-link"><a href="manage_leaves1.php?id=<?=$id?>">APPLY FOR LEAVE </a> </h6>  </button>
						</div>
					</div>
					...
					<thead>
							<tr>
							  ...
							  <th scope="col">LAID</th>
							   <th scope="col">FORMDATE</th>
							   <th scope="col">TILLDATE</th>
							...
							<tr>
							  ...
							  <td><?php echo $row['id']?></td>
							   ...
							   <td>
								...
								echo "<a href='manage_leaves.php?id=".$row['id']."'><h6 style=color:blue;>Edit</h6></a>&nbsp;";
								
								echo "<a href='employeeLeaveApplication.php?type=delete&employee_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>Delete</h6></a>";
								?>
							   </th>
