					...
					<thead>
						...
						<tbody>
							...
							<tr>
								...
								echo "<a href='manage_operation.php?id=".$row['id']."'><h6 style=color:blue;>Update</h6></a>&nbsp;";
								
								echo "<a href='operation.php?type=delete&machine_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>Delete</h6></a>";
