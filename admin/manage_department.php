...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			{
				$update_sql="update departments set name='$name',phone='$phone',details='$details',plant_id ='$plant_id' where id='$id'";
			}
			mysqli_query($con,$update_sql);
		}
		else
		{
			mysqli_query($con,"insert into departments (name,phone,details,plant_id)values('$name','$phone','$details','$plant_id')");
		}
		header('location:department.php');
		die();
	}
...
<body>
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><div class="weight-600 font-30 text-blue">DEPARTMENT</div></label>			
	</div>			
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>DEPARTMENT NAME </h6></label>
		<div class="col-sm-12 col-md-10">
			<input type="text" name="name" placeholder="ENTER DEPARTMENT NAME" class="form-control" required value="<?php echo $name?>">
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>DEPARTMENT PHONE </h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="phone" placeholder="ENTER DEPARTMENT PHONE" class="form-control" required value="<?php echo $phone?>">
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>DEPARTMENT DETAILS</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="details" placeholder="ENTER DEPARTMENT DETAILS" class="form-control" required value="<?php echo $details?>">
		</div>
	</div>
	<div class="form-group row">
		...
		<select class="form-control" name="plant_id">
										...
										<?php
										$res=mysqli_query($con,"select Id,name from plants order by name asc");
