...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='delete'){
		...
		$delete_sql="delete from plants where id='$id'";
...
$sql="select plants.id,plants.name,plants.address,plants.city,plants.state,plants.pincode,plants.email,plants.phone,
		companies.name as companyname from plants inner join companies on companies.id=plants.company_id";
			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">PLANT DETAIL</h4>
						</div>
					</div>
					<table class="table table-striped">
						<tbody>
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo "<a href='machine.php?id=".$row['id']."'>PLANT VIEW</a>&nbsp;";
							?></button>	
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo "<a href='manage_plant.php?id=".$row['id']."'>Update</a>&nbsp;";
							?></button>							
							<tr>
