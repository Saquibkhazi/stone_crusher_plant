			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">COMPANY DETAIL</h4>
						</div>
					</div>
					<table class="table table-striped">
						<tbody>
				<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo "<a href='manage_company.php?id=".$row['Id']."'>Update</a>&nbsp;";
							?></button>
							<tr>
							...
							<tr>
								<th scope="row">TAN NUMBER</th>
								<th><?php echo $row['tan']?></th>
							</tr>
							<tr>
