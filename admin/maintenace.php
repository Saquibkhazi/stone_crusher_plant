...
if(isset($_GET['type']) && $_GET['type']=='delete' && isset($_GET['machine_id']) && $_GET['machine_id']!=''){
	$type=get_safe_value($con,$_GET['type']);
	if($type=='delete'){
		$id=get_safe_value($con,$_GET['machine_id']);
		$delete_sql="delete from machinemaintenances where id='$id'";
			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">MAINTENANCE DETAIL</h4>
							  <button type="button" class="btn btn-outline-info"> <h6 class="box-link"><a href="manage_maintenace.php?type=add&machine_id=<?=$_GET['id']?>">ADD MACHINE MAINTENACE</a> </h6>  </button>
						</div>
					</div>
					...
					<thead>
						...
						<tbody>
							...
							<tr>
								...
								<th><?php echo $row['machine_id']?></th>
								<th><?php echo $row['employee_id']?></th>
								  <th>
								<?php
								
								echo "<a href='manage_maintenace.php?id=".$row['id']."'><h6 style=color:blue;>Update</h6></a>&nbsp;";
								
								echo "<a href='maintenace.php?type=delete&machine_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>Delete</h6></a>";
