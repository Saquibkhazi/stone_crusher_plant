			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">DEPARTMENT DETAIL</h4>
							  <button type="button" class="btn btn-outline-info"> <h6 class="box-link"><a href="manage_department.php">ADD DEPARTMENT</a> </h6>  </button>
						</div>
					</div>
					...
					<thead>
						...
						<tbody>
							...
							<tr>
								...
								echo "<a href='employee.php?id=".$row['id']."'><h6 style=color:blue;>Show Employees</h6></a>&nbsp;";
								
								echo "<a href='manage_department.php?id=".$row['id']."'><h6 style=color:blue;>Update</h6></a>&nbsp;";
