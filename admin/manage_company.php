...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	$res=mysqli_query($con,"select * from companies where id='$id'");
...
if(isset($_POST['submit'])){
	...
	$proprietor=get_safe_value($con,$_POST['proprietor']);
	...
	$tan=get_safe_value($con,$_POST['tan']);
	$pan=get_safe_value($con,$_POST['pan']);
	$res=mysqli_query($con,"select * from companies where name='$name'");
	$check=mysqli_num_rows($res);

	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			{
				$update_sql="update companies set name='$name',proprietor='$proprietor',address='$address',city='$city',state='$state',pincode='$pincode',email='$email',gst='$gst',tan='$tan',pan='$pan' where id='$id'";
			}
...
<body>
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><div class="weight-600 font-30 text-blue">COMPANY UPDATE</div></label>			
	</div>			
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>COMPANY NAME</h6></label>
		<div class="col-sm-12 col-md-10">
			<input type="text" name="name" placeholder="ENTER COMPANY NAME" class="form-control" value="<?php echo $name?>" required>
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>PROPRIETOR</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="proprietor" placeholder="ENTER PROPRIETOR NAME" class="form-control" required value="<?php echo $proprietor?>">
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>PINCODE</h6></label>
		<div class="col-sm-12 col-md-10">
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>GST</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="gst" placeholder="ENTER GST" class="form-control" required value="<?php echo $gst?>">
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>TAN</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="tan" placeholder="ENTER TAN" class="form-control" required value="<?php echo $tan?>">
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>PAN</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="text" name="pan" placeholder="ENTER PAN" class="form-control" required value="<?php echo $pan?>">
		</div>
	</div>
	<div class="form-group row">
