...
if(isset($_GET['type']) && $_GET['type']=='delete' && isset($_GET['department_id']) && $_GET['department_id']!=''){
	$type=get_safe_value($con,$_GET['type']);
	if($type=='delete'){
		$id=get_safe_value($con,$_GET['department_id']);
...
$sql="select * from employees where department_id=$_GET[id]";
						...
						<tbody>
							...
							<tr>
							   ...
							   <td><?php echo $row['department_id']?></td>
								...
								echo "<a href='employee.php?type=delete&department_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>DELETE</h6></a>&nbsp;";
