...
if(isset($_POST['submit'])){
	...
	$company_id=get_safe_value($con,$_POST['company_id']);
		...
		$res=mysqli_query($con,"select * from plants where name='$name'");
		$check=mysqli_num_rows($res);
	if($check>0){
		if(isset($_GET['id']) && $_GET['id']!=''){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			{
				$update_sql="update plants set name='$name',address='$address',city='$city',state='$state',pincode='$pincode',email='$email',phone='$phone',company_id='$company_id' where id='$id'";
			}
			mysqli_query($con,$update_sql);
		}
		else
		{
			mysqli_query($con,"insert into plants (name,address,city,state,pincode,email,phone,company_id)values('$name','$address','$city','$state','$pincode','$email','$phone','$company_id')");
		}
		header('location:plant.php');
		die();
	}
...
<body>
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><div class="weight-600 font-30 text-blue">PLANT UPDATE</div></label>			
	</div>				
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>PLANT NAME</h6></label>
		<div class="col-sm-12 col-md-10">
			<input type="text" name="name" placeholder="ENTER PLANT NAME" class="form-control" value="<?php echo $name?>" required>
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-sm-12 col-md-10">
		<input type="number" name="pincode" placeholder="ENTER PINCODE" class="form-control" required value="<?php echo $pincode?>">
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>PHONE NUMBER</h6></label>
		<div class="col-sm-12 col-md-10">
		<input type="tel" name="phone" placeholder="ENTER PHONE NUMBER" class="form-control" required value="<?php echo $phone?>">
		</div>
	</div>
	<div class="form-group row">
		<label for="name" class="col-sm-12 col-form-label"><h6>COMPANY</h6></label>
		<div class="col-sm-12 col-md-10">
			<select class="form-control" name="company_id">
				<option>Select Company</option>
					<?php
						$res=mysqli_query($con,"select Id,name from companies order by name asc");
