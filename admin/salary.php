...
$sql="select * from salaries where employee_id=$_GET[id] ";
			...
			<!-- Striped table start -->
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">SALARY DETAIL</h4>
					...
					<thead>
						...
						<tbody>
							...
							<tr>
								...
								echo "<a href='manage_salary1.php?id=".$row['id']."'><h6 style=color:blue;>Update</h6></a>&nbsp;";
								
								echo "<a href='salary.php?type=delete&employee_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>Delete</h6></a>";
