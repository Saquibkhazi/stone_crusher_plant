...
if(isset($_GET['type']) && $_GET['type']=='delete' && isset($_GET['plant_id']) && $_GET['plant_id']!=''){
	$type=get_safe_value($con,$_GET['type']);
	if($type=='delete'){
		$id=get_safe_value($con,$_GET['plant_id']);
		$delete_sql="delete from machines where id='$id'";
...
if(isset($_GET['id']) && $_GET['id']!='')
{
 ...
 $sql="select * from machines where plant_id='$id'";
		...
		<div class="pd-ltr-20">
			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<button type="button" class="btn btn-outline-info btn-md" >
								<a href="manage_machine.php"><h6 style=color:blue;>ADD MACHINE</h6></a>
						</button>
				...
				<div class="row align-items-center">
					<div class="col-md-4">
						<div class="form-group row">
							<label for="name" class="col-sm-12 col-form-label"><div class="weight-600 font-30 text-blue">MACHINES</div></label>			
						</div>
					</div>
				</div>
			</div>			
					...
					<?php 
						...
						<ul class="row">
							<li class="col-lg-12 col-md-6 col-sm-1">
								<div class="product-box">
									
									<div class="producct-img"><img src="../media/machine/<?php echo $row['image']?>"/></div>
			...
			<!-- Striped table start -->
				<div class="pd-20 card-box mb-30">
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								<th scope="row">DEPLOYMENTDATE</th>
								<td><?php echo $row['deploymentdate']?></td>
							</tr>
							<tr>
				...
				<!-- Striped table End -->
							...
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo  "<a href='maintenace.php?id=".$row['id']."'><h6 style=color:blue;>MAINTENANCE</h6></a>";
							?></button>
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo  "<a href='operation.php?id=".$row['id']."'><h6 style=color:blue;>OPERATING</h6></a>";
							?></button>
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo  "<a href='manage_machine.php?id=".$row['id']."'><h6 style=color:blue;>UPDATE</h6></a>";
							?></button>
							<button type="button" class="btn btn-outline-primary btn-md" ><?php
								echo  "<a href='machine.php?type=delete&plant_id=".$row['id']."&id=".$_GET['id']."'><h6 style=color:red;>DELETE</h6></a>";
							?></button>
